...
class Process(object):
    ...
    def analyze(self):
        ...
        #Write Gini coeffs list to file
        #self.ginisFile=open("hicss08/main/ginis_wkp_big.txt", 'w')
        #self.ginisFile.write("Ginis\n")
        #for gini in self.giniCoeffs:
            #self.ginisFile.write(str(gini)+"\n")
        #self.ginisFile.close()
